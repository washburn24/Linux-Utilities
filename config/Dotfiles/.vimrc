...
set nobackup noundofile noswapfile nowritebackup
set nowrap

" Change indent and tab expansion behavior for Python usability
set shiftwidth=4
set softtabstop=4
set expandtab
set tabstop=4

autocmd BufWritePre * :%s/\s\+$//e   " Remove trailing whitespace on exit
